...
//----------------------------------------
   ...
   * instead.
   *
   * @param headers incoming message headers from which to read the correlation ID if none is set in the exchange
   *               property.
   * @param exchangeProperties properties on the exchange being processed.
   * @param altCorrelationSource Optional supplier that provides a correlation ID from an alternative source, such as
